...
describe('Fungsionalitas Mengedit Informasi Ulos - Metode Random Testing', () => {
    //pre condition
    beforeEach(() => {
        LoginAndGoToUlosPage()
    });
    ...
    const testCases = [{
            testCase: 'Admin mnegedit data ulos dengan seluruh inputan terisi dengan valid input',
