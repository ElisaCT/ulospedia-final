    ...
    <div class="ml-80 pt-10 gap-6 mr-8">
        ...
        <div class="grid grid-cols-12 gap-5">
            <div class="col-span-6 relative">
                <img src="../../assets/images/Admin/dashboard-ulos.svg"
                    class="w-full">
                <div class="absolute inset-0 left-9 top-6 flex flex-col text-left pl-6 gap-2 text-neutral_10">
            ...
            <div class="col-span-6 relative">
                <img src="../../assets/images/Admin/dashboard-penenun.svg"
                    class="w-full">
                <div class="absolute inset-0 left-9 top-6 flex flex-col text-left pl-6 gap-2 text-neutral_10">
                    <h2 class="font-semibold text-4xl">30</h2>
