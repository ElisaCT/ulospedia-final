                  ...
                  <div class="flex flex-col gap-6 md:flex-row md:items-center pb-6">
                    ...
                    <div class="flex flex-row gap-6 w-auto">
                      <div class="flex md:w-2/3 gap-1">
                        ...
                        />
                        <span
                          class="inline-flex items-center px-3 text-sm text-neutral_80 bg-neutral_20 border border-gray-300 rounded"
                        >
                          cm
                        </span>
                      </div>
                  ...
                  <div class="flex flex-col gap-6 md:flex-row pb-6">
                    ...
                    <div class="flex items-center">
                      <label
                        for="dropzone-file"
                        :class="{
                          'flex flex-col items-center justify-center w-36 h-36 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-neutral_10': true,
