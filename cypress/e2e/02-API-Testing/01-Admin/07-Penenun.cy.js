...
describe('Valid Weaver API Tests', () => {
    ...
    // it('GET: Mendapatkan semua data penenun:should retrieve all weavers', () => {
    //     cy.request({
    //         method: 'GET',
    ...
    // it('GET: Mendapatkan data detail penenun berdasarkan ID: should retrieve weaver details by ID', () => {
    //     cy.request({
    //         method: 'GET',
    //         url: 'http://company.ditenun.com/api/v1/ulospedia/weavers',
    //         headers: {
    ...
    it('GET: Mendapatkan gambar/image penenun berdasarkan ID penenun: should retrieve weaver image by ID', () => {
        const weaverId = 10;
    ...
    //     cy.request({
    //         method: 'GET',
    //         url: 'http://company.ditenun.com/api/v1/ulospedia/weavers/count',
    //         headers: {
    //             'Authorization': `Bearer ${authToken}`,
    //             'Accept': 'application/json'
    //         }
    ...
    //     cy.request({
    //         method: 'DELETE',
    //         url: `http://company.ditenun.com/api/v1/ulospedia/weavers/${weaverId}`,
    //         headers: {
    //             'Authorization': `Bearer ${authToken}`,
    //             'Accept': '*/*'
    //         }
...
// it('GET: Mendapatkan gambar/image penenun berdasarkan ID penenundengan invalid credentials', () => {
//     const weaverId = 2;
//     //const authToken = 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJyZXdpbmExMjMiLCJpYXQiOjE2ODQ5ODU1OTgsImV4cCI6MTY4NTA3MTk5OH0.ZsjZ4UoAGAJKBLvLMIY5u-KgIGocw1e15EclfQJ4X6A';
